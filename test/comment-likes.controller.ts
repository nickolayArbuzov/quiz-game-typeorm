...
describe('AppController', () => {
  ...
  describe('comment-like-controller', () => {
    ...
    it('should return one comment after likes from first-user for both users', async () => {
        ...
        //await request(server).put(`/comments/${constants.variables.commentId}/like-status`).set('Authorization', `Bearer ${constants.variables.accessToken2}`).send(constants.like)
